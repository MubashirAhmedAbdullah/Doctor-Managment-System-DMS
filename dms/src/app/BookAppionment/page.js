...
export default function BookYourAppointment() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Appointment booked', { date, hospital, time })
  }
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0">
                  <Calendar
                    ...
                    onSelect={setDate}
                    initialFocus
                    disabled={(date) => !doctor.appointmentDays.includes(date.getDay())}
                  />
                </PopoverContent>
              </Popover>
            </div>
